...
rv $CPROPSQM layout.logo http://www.loway.ch/images/logo_piaf_200x72.png
...
rv $CPROPSQM cluster.servers piaf

add $CPROPSQM cluster.piaf.manager tcp:admin:amp111@127.0.0.1
add $CPROPSQM cluster.piaf.queuelog sql:P001
add $CPROPSQM cluster.piaf.monitored_calls /var/spool/asterisk/monitor/
