...
AMIPASSWD=`awk -F'=' '/^amiadminpwd/ {print $2}' /etc/elastix.conf`
PWD=`pwd`
...
rext $FILEELA 14 6 'ChanSpy(${QM_AGENT_LOGEXT})'webapps/web_QM3
...
add $CPROPSQM cluster.elastix.manager tcp:admin:${AMIPASSWD}@127.0.0.1
